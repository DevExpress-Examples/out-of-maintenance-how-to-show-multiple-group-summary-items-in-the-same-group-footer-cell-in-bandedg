...
namespace DevExpress.S170736 {
    public class MyBandedGridView : BandedGridView {        
        ...
        protected override void SynchronizeSummary()
        {
            base.SynchronizeSummary();
        }
        protected override List<SummaryItem> SynchronizeSummary(System.Collections.IList gridSum, Data.SummaryItemCollection summary)
        {
